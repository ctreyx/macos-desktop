...
import {
  ...
  translate,
  translation
} from "./chunk-I5TVNPDL.js";
import "./chunk-BWQADVN7.js";
import "./chunk-R4TOFAS2.js";
import {
  Feature_default
...
import {
  ...
  asImageLike,
  toArray
} from "./chunk-RWFTNYVN.js";
import "./chunk-AEEYLG2V.js";
import "./chunk-XC3ZSF2F.js";
import {
  ViewHint_default
} from "./chunk-JIORY3VM.js";
...
import {
  ...
  pickUrl,
  renderXYZTemplate
} from "./chunk-6PJDS6MW.js";
import {
  Source_default
} from "./chunk-ORATGR6Z.js";
import {
  ERROR_THRESHOLD,
  ImageTile_default,
  Tile_default,
...
addDecoder(7, () => import("./jpeg-JZBLFIJL.js").then((m) => m.default));
addDecoder([8, 32946], () => import("./deflate-UAXLUEQJ.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-F6QMWCFA.js").then((m) => m.default));
addDecoder(
  34887,
  () => import("./lerc-AIJOIKCU.js").then(async (m) => {
    await m.zstd.init();
    return m;
  }).then((m) => m.default)
);
